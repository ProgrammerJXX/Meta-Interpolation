...
class Dataset_MAVG(BaseDataset):
    def __init__(self, config, img_paths, sampler, mode, dtype=torch.float32, add_gussian=False):
        ...
        Note:
            This method initializes various attributes of the Dataset_MAVG class,
            including configuration, image paths, seed, sampler, mode, and noise level.
        """
        super(Dataset_MAVG, self).__init__() # 没有的话不继承BaseDataset的方法
